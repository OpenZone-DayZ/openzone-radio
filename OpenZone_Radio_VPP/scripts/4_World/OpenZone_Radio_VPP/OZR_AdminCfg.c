...
class OZR_ProfilesApplier : OZ_AdminCfgApplier
{
    override bool Apply(string json)
    {
        ...
        // І доїжджає до тих, хто вже в грі. Пакет синхронізації ядра клієнт
        // отримує на вході й далі не питає, тож без цього рядка кейпад і PTT
        // у онлайну лишались би зі старими смугами до перезаходу -- при тому,
        // що сервер уже рахує по нових.
