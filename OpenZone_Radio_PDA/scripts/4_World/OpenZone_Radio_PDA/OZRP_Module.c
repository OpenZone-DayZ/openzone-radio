...
class OZRP_Module : CF_ModuleWorld
{
    ...
    override void OnMissionStart(Class sender, CF_EventArgs args)
    {
        ...
        // Один вимикач на родину. Рація тримає свій прапорець (порядок
        // CF-модулів не гарантований, і в її OnMissionStart налаштування ядра
        // можуть бути ще не прочитані -- див. OZR_Log); коли родина стоїть
        // цілком, вирішує ядро.
